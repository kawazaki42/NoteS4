...
//
//class GaussSolver(val matrix: MutableMatrix<Double>) {
//    infix fun List<Double>.vecMinus(other: List<Double>) = zip(other) { a, b ->
//        a - b
//    }
//
//    infix fun List<Double>.vecMul(scalar: Double) = map { it * scalar }
//
//    fun solve() {
//        for (i in matrix.indices) {
//            val leadRow = matrix[i]
//            val lead = leadRow.first()
//            leadRow.replaceAll { it / lead }
//
//            for (j in i..<matrix.size) {
//                val row = matrix[j]
//                val first = row.first()
//
//                val sub = leadRow vecMul first
//                matrix[j] = matrix[j] vecMinus sub
//            }
//        }
//    }
//}
