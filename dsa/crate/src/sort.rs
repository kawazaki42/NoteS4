...
// /// bubble sort: O(n^2), where n is constantly 3
// ///
// ///
// fn find_median<T: PartialOrd>(arr: &mut [T; 3]) {
// // fn find_median<T: PartialOrd>(mut arr: [&T; 3]) {
//     // if arr[0] > arr[1] {
//         // std::mem::swap(&mut arr[0], &mut arr[1])
//         // (arr[0], arr[1]) = (arr[1], arr[0]);
//     // }
//     let window = &mut arr[0..=1];
//     let w = arr.windows(2).ref;
// }
...
// /// Performs a loop where each iteration compares each
// /// consecutive pair of array's positions and sets each pair's items
// /// in the correct order.
// ///
// /// - Time complexity: $O(n^2)$
// /// - Space complexity: $O(1)$
// ///
// /// Each iteration of the loop finds the maximum element of
// /// unsorted part of the array, then puts it in the end of unsorted part.
// ///
// /// End of the array forms the sorted part.
// ///
// /// Thus n-1 comparisons & swaps for 0th iteration, n-2 for 1st...
// ///
// /// So more precisely, $n^2/2$ elementary operations needed.
